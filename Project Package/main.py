...
def menu():    
    ...
    print("(1).IP loggers      (4).Google Dork        (7).Instagram viewer                             ")
    print("(2).Image search    (5).OSINT framework    (8).Facebook viewer        ~(License: GPLv3)~    ")
    print("(3).Privacy tools   (6).Account searcher   (9).See your ip address                          ")                                                                                          
    ...
    if opt == "7":
        os.system('cls' if os.name == 'nt' else 'clear')
        print("~Instagram viewer~")
        print("- https://storynavigation.com/")
        input("Press enter to go back: ")
        menu()
    if opt == "8":
        os.system('cls' if os.name == 'nt' else 'clear')
        print("~Facebook viewer~")
        print("- https://www.social-searcher.com/facebook-search/")
        input("Press enter to go back: ")
        menu()
    if opt == "9":
        # show ip address
